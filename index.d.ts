export declare const languages: ILanguages;
export declare const getItemTranslate: (languageName: keyof ILanguages, translatedTextName: keyof ILanguage) => string;
